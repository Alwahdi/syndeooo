---
name: syndeooo-workflow
description: Expert assistance for syndeooo — a production-grade Turborepo template for Next.js SaaS apps. Triggers on questions about syndeooo installation, setup, architecture, packages, customization, deployment, and development workflows.
---

# syndeooo

syndeooo is a production-grade Turborepo template for building Next.js SaaS applications. It provides a monorepo structure with multiple apps, shared packages, and integrations for authentication, database, payments, email, CMS, analytics, observability, security, and more.
